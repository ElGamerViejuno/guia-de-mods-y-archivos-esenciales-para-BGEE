...
Debes saber que por defecto, los hechizos de area en el juego no muestran ninguna plantilla previa a un lanzamiento, osea que no podemos medir bien las distancias para alcanzar con precisión a nuestros enemigos, pudiendo incluso dañar alguna vez por accidente a nuestros personajes. Esto podemos solucionarlo realizando una pequeña modificación dentro del archivo [b]Baldur.lua[/b] que podemos abrir con cualquier editor de textos. Este archivo lo podemos encontrar aquí; [b]C:\Users\TuNombreDeUsuario\Documents\Baldur's Gate - Enhanced Edition[/b] y buscando la línea [b]SetPrivateProfileString('Game Options','Show AOE','0')[/b] debemos cambiar el [b]'0'[/b] por un [b]'1'[/b]. Con este cambio ahora sí que podremos ver una plantilla cuando vayamos a lanzar un hechizos de area. Esta plantilla puede resultar un tanto "fea", pero se hace necesaria al comparar esta mecánica con otros juegos CRPG más actuales.

Si utilizas el mod [b]EEex[/b] y quieres ejecutar el juego junto a Steam para obtener tus logros y demás estadísticas en tu cuenta, debes ir a la carpeta raíz donde tienes instalado el  juego, renombra [b]InfinityLoader.exe[/b] a [b]Baldur.exe[/b], luego renombra [b]Baldur.exe[/b] a [b]BaldurReal.exe[/b], abre [b]InfinityLoader.ini[/b] con tu editor de textos, cambia [b]Baldur.exe[/b] en [b]ExeNames[/b] a [b]BaldurReal.exe[/b] y añade [b]BaldurReal.exe:Baldur.exe[/b] en [b]ExeSwitchAlias[/b]. Ahora podrás ejecutar el juego con [b]EEex[/b] como si fuera el ejecutable original de Steam.

Si necesitáis alguna guía tipo "walkthrough" podéis hecharle un vistazo a las guías de [b][url=http://islanegra.clandlan.net/]Isla Negra[/url][/b] que a pesar de ser muy antiguas son bastante completas (Pero no incluyen el contenido extra de las "Enhanced edition"). Ya no existe la página de ClanDlan, pero puedes acceder a esta guía en usando la página de Wayback Machine.
